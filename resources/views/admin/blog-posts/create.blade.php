<x-admin.layouts.app title="Yeni Blog Yazisi">
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-3xl font-bold text-gray-900">Yeni Blog Yazisi</h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <!-- Visual Editor -->
                    <div id="visualEditor">
                        <textarea id="tinymceEditor">{{ old('content') }}</textarea>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center" id="imagePreviewArea">
                        <div id="imagePreview" class="hidden mb-3">
                            <img id="previewImg" src="" alt="" class="w-full h-40 object-cover rounded">
                        </div>
                        ...
                        <button type="button" onclick="document.getElementById('imageInput').click()" class="mt-2 text-xs text-blue-600 hover:text-blue-800">Gorsel Sec</button>
                    </div>
                    @error('image')
